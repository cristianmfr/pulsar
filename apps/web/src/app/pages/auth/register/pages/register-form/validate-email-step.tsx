...
import { ValidateCodeSchema, ValidateCodeType } from '../../types/validate-code-schema'
...
export const ValidateEmailStep = () => {
  ...
  const [verifyRegistrationCode] = useMutation(CREATE_CUSTOMER)
  ...
  return (
    <form onSubmit={handleSubmit(handleVerifyRegistrationCode)} className={cn('flex flex-col gap-6')}>
      <div className='flex flex-col items-center gap-2 text-center'>
        <span className='flex flex-row gap-2 text-2xl font-bold'>Vamos validar seu email</span>
      ...
      <div className='grid gap-6'>
        <div className='grid gap-2'>
          ...
          <Input id='code' type='text' placeholder='123456' required {...register('code')} />
        </div>
