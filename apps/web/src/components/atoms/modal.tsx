        ...
        >
          <div
            ...
            className={clsx(
              ...
              theme === 'red' && 'bg-[#CD0000]',
              `rounded-xl border overflow-scroll scrollbar-hide duration-200 ${
                isOpen ? 'animate-in zoom-in ease-out' : 'animate-out zoom-out ease-in'
              }`,
            )}
          >
            ...
            <div className='px-[20px] py-[15px] overflow-scroll scrollbar-hide'>{children}</div>
          </div>
        </div>,
        document.body,
      )}
