...
function CustomTooltip({ active, payload, label }: TooltipProps<number, number>) {
...
export function ReceiptChart() {
  const dailyReceiptInPeriod = [
    { date: '2023-10-01', receipt: 150 },
    { date: '2023-10-02', receipt: 200 },
    { date: '2023-10-03', receipt: 250 },
    { date: '2023-10-04', receipt: 300 },
    { date: '2023-10-05', receipt: 350 },
    { date: '2023-10-06', receipt: 400 },
    { date: '2023-10-07', receipt: 450 },
  ]
  const isLoadingDailyReceiptInPeriod = false
      ...
      <CardHeader className='flex flex-row items-center justify-between pb-8'>
        <div className='space-y-1'>
          <CardTitle className='flex items-center gap-2 text-base font-medium'>
            Receita no período
            {isLoadingDailyReceiptInPeriod && <Loader2 className='h-4 w-4 animate-spin text-muted-foreground' />}
          </CardTitle>
            ...
            {dailyReceiptInPeriod.length > 0 ? (
              <ResponsiveContainer width='100%' height={240}>
                <LineChart data={dailyReceiptInPeriod} style={{ fontSize: 12 }}>
                  ...
                  <Line type='linear' strokeWidth={2} dataKey='receipt' stroke={violet['500']} />
              ...
              <div className='flex h-[240px] w-full flex-col items-center justify-center gap-0.5'>
                <span className='text-sm text-muted-foreground'>Nenhum resultado encontrado para o período.</span>
                <Button variant='link' size='sm' className='text-violet-500 dark:text-violet-400'>
